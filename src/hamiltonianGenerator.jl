...
# functions to generate hamiltonian function of variable z and order 3 of combinations with 2 dims for each variable
...
# ˍ₋arg1 = z (p,q) of dims = 2 each 
# where a is of size 34. The function below only works for poly order = 3
# t is unused and is only present to comply with ODEProblem syntax
