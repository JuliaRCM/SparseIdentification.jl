...
xid = ODE.solve(
    prob_approx, ode4(), abstol = 1e-10, reltol = 1e-10, saveat = trange, tstops = trange)
...
p3 = scatter!(xid[1, :], xid[2, :], label = "approx", linestyle = :dash,
    mc = :red, ms = 2, ma = 0.5, xlabel = "X1", ylabel = "X2")
