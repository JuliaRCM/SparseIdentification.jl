...
for i in 1:5
    ...
    plot!(xlabel = "Time", ylabel = "Position", size=(1000,1000))
    display(plot(p1, p3, p5, title="Analytical vs Calculated Positions"))

    # plot momenta
    p2 = plot(xlabel = "Time", ylabel = "momentum")
    ...
    p4 = plot(xlabel = "Time", ylabel = "momentum")
    ...
    display(plot(p2, p4, p6, title="Analytical vs Calculated Momenta"))
